...
return null;},getNodeTarget:function(e){var t=e.getTarget('.x-tree-node-icon',1);if(!t){t=e.getTarget('a.x-tree-node-anchor',4);}
return t;},delegateClick:function(e,t){if(!this.beforeEvent(e)){return;}
