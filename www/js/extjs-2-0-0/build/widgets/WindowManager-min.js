...
Ext.WindowGroup=function(){var list={};var accessList=[];var front=null;var sortWindows=function(d1,d2){return(!d1._lastAccess||d1._lastAccess<d2._lastAccess)?-1:1;};var orderWindows=function(){accessList.sort(sortWindows);var seed=Ext.WindowMgr.zseed;for(var i=0,len=accessList.length;i<len;i++){var win=accessList[i];if(win&&!win.hidden){win.setZIndex(seed+(i*10));}}
